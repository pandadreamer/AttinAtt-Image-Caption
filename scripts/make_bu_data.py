...
infiles = ['trainval/test2014_resnet101_faster_rcnn_genome.tsv',
         'trainval/val2014_resnet101_faster_rcnn_genome.tsv',\
         'trainval/train2014_resnet101_faster_rcnn_genome.tsv.1']

# infiles = ['trainval/karpathy_val_resnet101_faster_rcnn_genome.tsv']
